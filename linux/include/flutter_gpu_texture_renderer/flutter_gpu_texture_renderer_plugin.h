...
typedef struct _FlutterGpuTextureRendererPlugin FlutterGpuTextureRendererPlugin;
typedef struct {
  GObjectClass parent_class;
} FlutterGpuTextureRendererPluginClass;

FLUTTER_PLUGIN_EXPORT GType flutter_gpu_texture_renderer_plugin_get_type();
